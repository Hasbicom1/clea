...
import { ArrowLeft, Fingerprint, CreditCard } from 'lucide-react-native';
      ...
      <View style={styles.contentContainer}>
        ...
        >
          ...
          <View style={styles.inputContainer}>
            <TextInput
              style={styles.input}
              placeholder="Användarnamn/kontonummer"
          ...
          <View style={styles.alternateMethodsContainer}>
            <TouchableOpacity 
              ...
              onPress={() => router.push('fingerprint-login')}
            >
            ...
            >
              <CreditCard size={30} color="#0277BD" />
            </TouchableOpacity>
          </View>
        </Animated.View>
      </View>
