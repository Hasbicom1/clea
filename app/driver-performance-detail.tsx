...
export default function DriverMonitoringScreen() {
  ...
  const renderMainTabs = () => (
    <View style={styles.mainTabsContainer}>
      <TouchableOpacity 
        style={[styles.mainTab, activeTab === 'drivingTime' && styles.activeMainTab]}
        onPress={() => setActiveTab('drivingTime')}
      >
        <Clock3 size={20} color={activeTab === 'drivingTime' ? 'white' : '#666'} />
        <Text style={[styles.mainTabText, activeTab === 'drivingTime' && styles.activeMainTabText]}>
          Vilotidsrapport
        </Text>
      </TouchableOpacity>
      
      <TouchableOpacity 
        style={[styles.mainTab, activeTab === 'performance' && styles.activeMainTab]}
        onPress={() => setActiveTab('performance')}
      >
        <BarChart2 size={20} color={activeTab === 'performance' ? 'white' : '#666'} />
        <Text style={[styles.mainTabText, activeTab === 'performance' && styles.activeMainTabText]}>
          Driver Performance
        </Text>
      </TouchableOpacity>
    </View>
  ...
  const renderDrivingTime = () => (
    <View style={styles.drivingTimeContent}>
      ...
      >
        ...
        <Text style={styles.linkButtonText}>Check Driving Performance</Text>
      </TouchableOpacity>
    </View>
  );
