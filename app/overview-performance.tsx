...
export default function OverviewPerformanceScreen() {
  return (
      ...
      <View style={styles.content}>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={[styles.statCard, styles.activeStatCard]}>
            <View style={styles.statContent}>
              <View>
                <Text style={[styles.statLabel, styles.activeStatLabel]}>Bil basprestanda</Text>
                <Text style={[styles.statValue, styles.activeStatValue]}>73%</Text>
              </View>
              <Text style={[styles.scoreText, styles.activeStatSubtext]}>Totalt</Text>
            </View>
          </View>
